  ...
  export default {
    data: () => ({
      props: [ {
        ...
        description: `Used in conjunction with ${code('showCount')} to specify which type of count number should be displayed. <br>Acceptable values: ${code('"ALL_CHILDREN"')}, ${code('"ALL_DESCENDANTS"')}, ${code('"LEAF_CHILDREN"')}, ${code('"LEAF_DESCENDANTS"')}.`,
      }, {
